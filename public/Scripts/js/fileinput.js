...
(function (factory) {
    ...
    $.fn.fileinput.defaults = {
        ...
        browseClass: 'btn bg-gray text-black',
        removeIcon: '<i class="glyphicon glyphicon-trash"></i>',
...
(function ($) {
    ...
    $.fn.fileinputLocales['ar'] = {
        ...
        msgNoFilesSelected: '',
        msgCancelled: 'ألغيت',
        msgPlaceholder: 'أختر {files}...',
        msgZoomModalHeading: 'معاينة تفصيلية',
        msgFileRequired: 'You must select a file to upload.',
        msgSizeTooSmall: 'الملف "{name}" (<b>{size} KB</b>) is too small and must be larger than <b>{minSize} KB</b>.',
...
(function ($) {
    ...
    $.fn.fileinputThemes.fa = {
        ...
        previewZoomButtonIcons: {
            ...
            borderless: '<i class="fas fa-fw fa-arrows-alt-h"></i>',
