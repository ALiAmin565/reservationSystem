...
@section('content')
                            ...
                            <table class="table datatable text-center">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">حذف</th> <!-- Added delete column header -->
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($userServices as $userService)
                                        @if ($userService->reservation)
                                            <tr>
                                                ...
                                                {{-- <td>{{ $userService->active ? 'تفعيل' : 'غير مفعل' }}</td> --}}
                                                <td>
                                                ...
                                                <td>
                                                    <form
                                                        action="{{ route('user_services.soft_delete', $userService->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
    ...
    tableBody.innerHTML = `
        ...
        <tr><td>حاله الطلب</td><td>${userService.active === 1 ? 'مفعل' : 'ليس مفعل'}</td></tr>
