            ...
            <div class="col-lg-4">
                <div class="card mb-4">
                    <div class="card-body text-center">
                        ...
                        <h5 class="my-3">الاسم </h5>
                        <p class="text-muted mb-1">رقم التلفون </p>
                        <p class="text-muted mb-4">الايميل </p>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <p class="text-muted mb-0">هنحطه هنا</p>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mb-4 mb-md-0">
                            <div class="card-body">
                                <p class="mb-4"><span class="text-primary font-italic me-1">بيانات التعاقدات
                                        السابقة</span>
                                </p>
                                <table class="table">
                                    <thead>
